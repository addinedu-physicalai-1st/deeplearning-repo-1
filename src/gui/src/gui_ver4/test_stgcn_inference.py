...
# 이 스크립트가 위치한 gui_ver4 폴더 기준 상대 경로
_BASE_DIR = Path(__file__).resolve().parent
_STGCN_DIR = _BASE_DIR / "st_gcn"
_YOLO_DIR = _BASE_DIR / "yolo" / "myproj"

# 기본 경로 (프로젝트 내부 상대경로)
DEFAULT_MODEL_PATH = str(_STGCN_DIR / "checkpoints" / "best_model_binary.pth")
DEFAULT_YOLO_PATH = str(_YOLO_DIR / "yolo11s-pose.pt")
DEFAULT_VIDEO_PATH = str(_STGCN_DIR / "data_integrated" / "fall-01-cam0.mp4")
