    ...
    def __init__(self, user_info: dict, db: DatabaseManager):
        ...
        if YOLO_AVAILABLE:
            try:
                ...
                yolo_path = base_dir / "yolo" / "myproj" / "models" / "yolo11s-pose.pt"
                if yolo_path.exists():
        ...
        try:
            ...
            base_dir = Path(__file__).resolve().parent
            model_path = base_dir / "yolo" / "myproj" / "models_integrated" / "binary_v3" / "random_forest_model.pkl"
    ...
    def init_stgcn_model(self):
        ...
        try:
            self.stgcn_model = STGCNInference(
                model_path='/home/tonyno/dev_ws/st_gcn/checkpoints_v2/best_model.pth'
            )
